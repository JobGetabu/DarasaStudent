...
public class SignupActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> authtask) {
                            if (authtask.isSuccessful()) {
                                ...
                                writingToStudUsers(pDialog, devicetoken, FirebaseAuth.getInstance().getCurrentUser(),mCurrentUserid);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                signupViaGoogle.setEnabled(true);
            }
        }
    }
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        ...
        final SweetAlertDialog pDialog = new SweetAlertDialog(this, SweetAlertDialog.PROGRESS_TYPE);
        pDialog.getProgressHelper().setBarColor(Color.parseColor("#FF5521"));
        pDialog.setTitleText("Buckle up...");
        pDialog.setCancelable(false);
        pDialog.show();
